...
const FAQS = [
  ...
  { q: "How accurate is the AI skin analysis?", a: "Glowa's skin analysis has been validated by Dr. Logan M. Horejsi, MD — Board-Certified Dermatologist and Glowa AI Medical Advisor. The model scores 6 skin metrics on a 0–100 scale based on frontal and profile photo analysis. Individual results may vary based on skin type, photo quality, and lighting conditions." },
