    ...
    <section className="advisors section snap-section" id="advisors" data-snap-index="5" data-snap-label="Advisor">
      <div className="container">
        <div className="section-header">
          <span className="label">Clinical Advisory</span>
          <h2>Clinical expertise behind every recommendation</h2>
          <p>Glowa AI is designed and validated in partnership with clinical experts — not just engineers. Every skin analysis reflects what a real dermatologist would advise.</p>
        </div>
        <div className="advisor-card">
          <div className="advisor-photo" role="img" aria-label="Logan M. Horejsi">
